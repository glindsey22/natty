package com.camio.natty.grammar;
...
import com.camio.natty.ANTLRNoCaseInputStream;
import com.camio.natty.ParseListener;
import com.camio.natty.generated.DateLexer;
import com.camio.natty.generated.DateParser;
import com.camio.natty.generated.TreeRewrite;
...
public abstract class AbstractGrammarTest {
  ...
  protected String buildAST(String value) throws Exception {
    ...
    Class<?> klass = Class.forName("com.camio.natty.generated.DateParser");
