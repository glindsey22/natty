...
@header { package com.camio.natty.generated; }

@members {
  private com.camio.natty.WalkerState _walkerState;
  ...
  public com.camio.natty.WalkerState getState() {
    if(_walkerState==null) {
      _walkerState = new com.camio.natty.WalkerState(referenceDate);
    }
    return _walkerState;
  }
}
